...
let g:ycm_global_ycm_extra_conf = '/Users/pranay.garg/.vim/.ycm_extra_conf.py'
...
autocmd filetype cpp nnoremap <C-b> :w <bar> !g++ -Wall -Wno-unused-result -std=c++17   -O2   % -o %:r && ./%:r <CR>
